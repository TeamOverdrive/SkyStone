...
Basic:	    This is a minimally functional OpMode used to illustrate the skeleton/structure
            of a particular style of OpMode.  These are bare bones Tank Drive org.firstinspires.ftc.teamcode.examples.
...
Eg: from the org.firstinspires.ftc.teamcode.examples above:  tool, leftMotor, rightClawServo, rearLightSensor.
